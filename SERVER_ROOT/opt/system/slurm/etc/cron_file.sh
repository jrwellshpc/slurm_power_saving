#!/bin/sh
# This is a cron file that should run daily and do maintenance tasks, like ensure your environment stays up to date.
# The below will print a list of the suspended nodes:
